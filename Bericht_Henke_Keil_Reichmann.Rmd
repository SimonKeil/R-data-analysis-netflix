...
Da dies aber höchstens den Anstieg ab 2012/13 erklären würde (und dieser nicht erkennbar höher als die Jahre zuvor), ist dieser Anstieg vermutlich eher mit einem allgemeinen Anstieg an Genre-Diversität in der Film- und TV-Industrie. Da unsere Daten aber nur eine Teilmenge aller Filme und Serien darstellt, können wir einen allgemeinen Trend nicht definitiv nachweisen. 
