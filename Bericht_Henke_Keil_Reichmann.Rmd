...
Zunächst einmal lesen wir die Daten ein, und bringen sie auf ein Brauchbares Format.
Uns interessieren vor allem die Variablen "Title", "Genre", "Country Availability" und "Release Date". Dabei teilen wir die Einträge in "Country Availability" und "Release Date" in mehrere Zeilen auf.
```{r, message=FALSE}
library("tidyverse")
