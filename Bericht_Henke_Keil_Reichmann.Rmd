...
data_basic <- raw_data %>% rename(country = 'Country Availability') %>% 
...
Man sieht, dass es starke Unterschiede zwischen den einzelnen Ländern gibt und dass keine Gruppenbildung in z.B. Länder mit sehr viel und Ländern mit weniger Auswahl zu erkennen ist.
