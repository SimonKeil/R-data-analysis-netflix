...
- Explorativ:
    ...
    - Jahr vs Anzahl Genre (pro film) (neueren Filme nicht vielen Genren zugeordnet) (Simon)
...
- Analyse
    ...
    - lineare regression (mit residuen, koeffizienten(pro jahr wie viele genres durchschnittlich)) [mach der computer]
